...
export default function Tech() {
  ...
  return (
    <div className='h-full w-full mx-auto  max-w-screen-xl px-5 md:px-0 sm:px-10 overflow-hidden  flex items-center justify-center flex-col text-3xl gap-4 my-5' >
        ...
        {isLoading ? <MoonLoader/> : memoizedIcons.map((data, index) => {
          return (
            <>
                ...
                <data.icon.icon alt={data.header} className='text-[50px] max-sm:text-[40px] ' fill={data.icon.primaryColor} data-tooltip-id={`my-tooltip-children-multiline${index}`} />
