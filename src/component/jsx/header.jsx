...
export function Showprofile() {
  ...
  return (
    <div className='Showprofile'>
       ...
       <h2 className='I-am-Full-stack'>I am a <span className='element' style={{color:"orange"}}><TextTransition springConfig={presets.wobbly} inline="true">{TEXTS[index % TEXTS.length]}</TextTransition></span></h2>
       </div>
