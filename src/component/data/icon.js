...
},
{
    ...
    "header":"JavaScript",
    "about":"this language is used both on the client-side and server-side that allows you to make web pages interactive.",
    "value":"2"
},
{
...

{
    ...
    "header":"MySql",
    "about":"it's relational database management system based on SQL.",
    "value":"4"
},
{
    "img":"https://www.freeiconspng.com/thumbs/sql-server-icon-png/sql-server-icon-8.png",
    "header":"SqlServer",
    "about":"it's used for storing all the desired information in relational databases.",
    "value":"5"
},
{
    "img":"https://static-00.iconduck.com/assets.00/django-icon-1606x2048-lwmw1z73.png",
    "header":"Django",
    "about":"it's Python web framework that enables rapid development of secure and maintainable websites.",
    "value":"6"
},
{
...
{
    "img":"https://docs.infomaniak.cloud/pictures/logo/docker.png",
    "header":"Docker",
